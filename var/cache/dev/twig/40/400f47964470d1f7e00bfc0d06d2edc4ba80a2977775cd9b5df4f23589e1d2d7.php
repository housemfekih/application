...
{% block panel %}
    ...
    {% endfor %}
{% endblock %}
", "WebProfilerBundle:Collector:validator.html.twig", "/home/houssem/myApp/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views/Collector/validator.html.twig");
    }
}
