...
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/champ/'), array(0 => 'IS_AUTHENTICATED_FULLY'), NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/cv/'), array(0 => 'IS_AUTHENTICATED_FULLY'), NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/section/'), array(0 => 'IS_AUTHENTICATED_FULLY'), NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/groupe/'), array(0 => 'IS_AUTHENTICATED_FULLY'), NULL);
$instance->add($a, array(0 => 'IS_AUTHENTICATED_FULLY'), NULL);
